...
"""
    ...
    data = run_simian(pm=pm, seed=123456789, quiet=quiet)
    assert data[0] == [
        (0, ("a1",)),
        (1, ("a1",)),
        (2, ("a1",)),
    ...
    data = run_simian(pm=pm, max_delay_before=5, seed=123456789, quiet=quiet)
    assert data[0] == [
        (0, ()),
        (1, ()),
        (2, ()),
...
def test_ex7():
    ...
    data = run_simian(pm=pm, seed=1234567, quiet=quiet)
    assert data[0] == [
        (0, ("a1",)),
        (1, ("a1",)),
        (2, ("a1",)),
